...
import characterImage from "../../../assets/Characters-1.png";
import character from "../../../assets/Characters-15.png";
      ...
      {!isGameStarted && (
        <div className={styles.lobby}>
          ...
          <button onClick={startGame}>
            {true ? "Start game" : "Rozpocznij grę"}
          </button>
        </div>
      )}
        ...
        <div className={styles["question-preview"]}>
          ...
          <div className={styles["leaderboard"]}>
            <h1 className={styles["leaderboard-title"]}>
              {true ? "Question result" : "Wynik pytania"}
            </h1>
            <ol>
